!function(e) {
    ...
    , function(e, i, t) {
        ...
        function n(e, i, t) {
            ...
            if (s.c_contact = (0,
                    p.getRandomItemFromList)(s.c_contact.split("|")),
                    s.c_before_qq = (0,
                        p.getRandomItemFromList)(s.c_before_qq.split("|")),
                    s.c_after_qq = (0,
                        p.getRandomItemFromList)(s.c_after_qq.split("|")),
                    e.c_service_time) {
                s.c_service_time = [];
            ...
            if (i.length && parseInt(i[0].activeId) === m.ACTIVITY_TYPE.ZERO) {
                var r = i[0];
                s.isZeroSerivce = !0,
                    s.zeroActiveCount = Math.max(r.stockNums - r.dealNums, 0),
                    s.zeroActiveTime = r.activeEndtime - G_DATA.nowTime
            }
            if (s.sku_province_ids = [],
                    s.sku_city_ids = [],
                    s.periodsAry = [],
                    I.skuInfo.forEach(function(e) {
        ...
        function r(e, i) {
            ...
            return i.length > 0 && parseInt(i[0].activeId, 10) !== m.ACTIVITY_TYPE.ZERO && (t = i.map(function(e) {
                ...
                e = e.map(function(e) {
                    ...
                    if (s !== -1) {
                        var a = i[s];
                        e.activeId = a.activeId,
                            e.activeEndtime = a.activeEndtime,
                            e.activeDeduction = a.activeDeduction,
                            e.activeBegintime = a.activeBegintime
                    }
                    return e.sku_province_ids = e.sku_province_ids.split(","),
                        e.sku_city_ids = e.sku_city_ids.split(","),
                        e
                })
        }
        function d(e, i) {
        ...
        function o(e, i) {
            ...
            if (t.indexOf("999999") !== -1)
                return !0;
            var s = [];
            return t.forEach(function(e) {
                if (y["default"][e])
                    for (var i in y["default"][e].city)
                        s.push(i);
                else
                    s.push(e)
            }),
        ...
        var _ = Object.assign || function(e) {
            ...
            lastUsedLocation: (0,
                h.getLastUsedLocationFromCache)(),
        ...
        var D = function() {
            ...
            return u(e, [{
                ...
                key: "getLastUsedLocationFromServer",
                value: function(e) {
                    b["default"].request({
                        url: k,
                        success: function(i) {
                            0 === i.ret && +i.data.lastUsedProvinceId && +i.data.lastUsedCityId && (I.lastUsedLocation.lastUsedProvinceId = i.data.lastUsedProvinceId,
                                I.lastUsedLocation.lastUsedCityId = i.data.lastUsedCityId,
                                e(i.data.lastUsedProvinceId, i.data.lastUsedCityId))
                        }
                    })
                }
            }, {
                ...
                value: function(e, i) {
                    ...
                    var t = {
                        ...
                        if (e.discountPriceList.push(a),
                                e.originPriceList.push((0,
                                    p.toDecimal)(+t.sku_price / 100)),
                                e.idList.push(t.sku_id),
                                i.isZeroSerivce)
                            return e;
                        if (s || +t.activeId !== m.ACTIVITY_TYPE.HB || (s = !0,
                                e.hongbaoInfo = {
                                    deduction: 0,
                                    deductionCount: 0,
                                    realPrice: -1,
                        ...
                        if (t.activeDeduction > 0) {
                            n.deductionCount++,
                            (0 === n.deduction || +t.activeDeduction < n.deduction) && (n.deduction = +t.activeDeduction);
                            var c = Math.round(100 * a, 10) - t.activeDeduction;
                            (n.realPrice === -1 || c < n.realPrice) && (n.realPrice = +c)
                        }
                        var r = t.activeEndtime - G_DATA.nowTime;
                        return r > 0 && (0 === n.activeRemainTime || r > n.activeRemainTime) && (n.activeRemainTime = r),
                        t.activeBegintime - G_DATA.nowTime > 0 && n.activeNotBeginCount++,
                            e
                    }, t);
    ...
    , function(e, i) {
        ...
        function t(e, i) {
            try {
                localStorage.removeItem("lastUsedLocation"),
                    localStorage.setItem("lastUsedLocation", e + "#" + i)
            } catch (t) {}
        }
        function s() {
            var e = "";
            try {
                if (e = localStorage.getItem("lastUsedLocation"))
                    return {
        ...
        Object.defineProperty(i, "__esModule", {
            ...
            i.setLastUsedLocationToCache = t,
            i.getLastUsedLocationFromCache = s
    }
    , function(e, i) {
                ...
                var n = function() {
                    ...
                    return n(i, [{
                        ...
                        value: function(i) {
                            ...
                            e(".jmod-tips").html(a),
                                e(".jmod_close_tips").on("click", function(i) {
                                    e(i.currentTarget).parent().hide()
                                })
                        }
                    }, {
                        key: "renderActivePrice",
                        value: function(i, t) {
                            var s = (0,
                                c.tmpl)(_.activePriceTpl, {
                                serviceData: i,
                                displayInfo: t
                            });
                            e(".jmod-active-price").html(s),
                                this.renderActiveInfo(i, t)
                        }
                    }, {
                        key: "renderSelectCtrl",
                        value: function(i, t, s, a) {
                            var n = (0,
                                c.tmpl)(u.selectCtrlTpl, {
                                serviceData: i,
                                addressIndex: t,
                                locationData: s,
                                serviceTime: a
                            });
                            e(".jmod-select-ctrl").html(n),
                                e(".jmod_select_address").bind("click", function(i) {
                                ...
                                e(".jmod_select_province_city").on("click", ".item-in", function(i) {
                                    ...
                                    t.parent().addClass("cur").siblings().removeClass("cur"),
                                        0 === t.parent().index() ? (e(".jmod_select_province").show(),
                                            e(".jmod_select_city").hide()) : (e(".jmod_select_city").show(),
                                            e(".jmod_select_province").hide())
                                }),
                                e(".jmod_select_province").on("click", ".address-item", function(a) {
                                    ...
                                    var c = n.attr("_province_id")
                                        , r = []
                                        , d = [];
                                    for (var o in s[c].city)
                                        d.push(o);
                                    if (~i.sku_city_ids.indexOf(c) || ~i.sku_city_ids.indexOf("999999"))
                                        r = d;
                                    else
                                        for (var l = 0, v = i.sku_city_ids.length; l < v; l++)
                                            ~d.indexOf(i.sku_city_ids[l]) && r.push(i.sku_city_ids[l]);
                                    for (var _ = "", u = 0, p = r.length; u < p; u++)
                                        _ += '<div class="address-item" _city_id="' + r[u] + '"><span>' + t[r[u]] + "</span></div>";
                                    e(".jmod_select_province").hide(),
                                        e(".jmod_select_city").html(_).show(),
                                        e(".jmod_select_province_city div:eq(0)").attr("_province_id", c).removeClass("cur").find("span").text(n.text()),
                                        e(".jmod_select_province_city div:eq(1)").addClass("cur").find("span").text("请选择")
                                })
                        }
                    }, {
                        key: "renderCorpInfo",
                        value: function(i) {
                            var t = (0,
                                c.tmpl)(p.corpInfoTpl, {
                                serviceData: i,
                                clearProtocol: c.clearProtocol
                            });
                            e(".jmod-corp-info").html(t),
                                e(".jmod_company_wrap").on("click", ".tab-item", function(i) {
                                    var t = e(i.currentTarget);
                                    t.addClass("cur").siblings().removeClass("cur"),
                                        e(".jmod_company_content_wrap div:eq(" + t.index() + ")").show().siblings().hide()
                                })
                        }
                    }, {
                        key: "renderSKUDetail",
                        value: function(i) {
                            var t = (0,
                                c.tmpl)(m.skuDetailTpl, {
                                serviceData: i
                            });
                            e(".jmod-sku-detail").html(t),
                                e(".jmod_detail_wrap").html((0,
                                    c.restHTML)((0,
                                    c.clearProtocol)(i.s_detail, 0)))
                        }
                    }, {
                        key: "renderPlatformGarantee",
                        value: function() {
                        ...
                        value: function(i) {
                            e(".jmod_select_period").on("click", ".ui-tag", function(t) {
                                ...
                                s.toggleClass("checked"),
                                    s.siblings().filter(".ui-tag").removeClass("checked");
                        ...
                        value: function(i, t, s, a, n) {
                            e(".jmod_select_city").on("click", ".address-item", function(c) {
                                ...
                                e(".jmod_select_address").parent().removeClass("ui-address-open").addClass("ui-address-close"),
                                    d.addClass("checked").siblings().removeClass("checked");
                                var o = d.attr("_city_id")
                                    , l = e(".jmod_select_province_city div:eq(0)").attr("_province_id");
                                (0,
                                    r.setLastUsedLocationToCache)(l, o),
                                    e(".jmod_select_province_city div:eq(1)").attr("_city_id", o).find("span").text(d.text()),
                                    e(".jmod_address_text").attr("_province_id", l),
                                    e(".jmod_address_text").attr("_city_id", o),
                                    e(".jmod_address_text").text(t[l] + " " + t[o]);
                                for (var v = void 0, _ = 0, u = i.periodsAry.length; _ < u; _++) {
                                    v = [];
                                    for (var p = 0, m = a.length; p < m; p++)
                                        if (a[p].sku_service_time === i.periodsAry[_])
                                            for (var f = 0, y = a[p].sku_city_ids.length; f < y; f++) {
                                                if ("999999" === a[p].sku_city_ids[f]) {
                                                    v.push("999999");
                                                    break
                                                }
                                                if (s[a[p].sku_city_ids[f]])
                                                    for (var h in s[a[p].sku_city_ids[f]].city)
                                                        v.push(h);
                                                else
                                                    v.push(a[p].sku_city_ids[f])
                                            }
                                    ~v.indexOf(o) || ~v.indexOf("999999") ? (e('.jmod_select_period .ui-tag[_period_id="' + i.periodsAry[_] + '"]').removeClass("disabled"),
                                        e('.jmod_select_period .ui-tag[_period_id="' + i.periodsAry[_] + '"]').removeAttr("disabled")) : (e('.jmod_select_period [_period_id="' + i.periodsAry[_] + '"]').removeClass("checked").addClass("disabled"),
                                        e('.jmod_select_period [_period_id="' + i.periodsAry[_] + '"]').removeAttr("disabled").attr("disabled", "disabled"))
                                }
                        ...
                        key: "renderZeroActiveInfo",
                        value: function(i) {
                            var t = "此商品仅剩" + i.zeroActiveCount + '件，<span class="price-board-t">' + (0,
                                c.formatRemainTime)(i.zeroActiveTime - f, 2) + "</span>后结束！";
                            e(".jmod_active_remain_time").html(t),
                                this.countRemainTime(i, i.zeroActiveTime - f)
                        }
                    }, {
                        key: "renderActiveInfo",
                        value: function(e, i) {
                        ...
                        value: function(e, i) {
                            y !== -1 && clearTimeout(y),
                                this.startCountRemainTime(e, i)
                        }
                    }, {
                        key: "startCountRemainTime",
                        value: function(e, i) {
                            var t = this;
                            this.renderRemainTime(e, i),
                                i > 0 ? y = setTimeout(function() {
                                    f++,
                                        t.startCountRemainTime(e, --i)
                                }, 1e3) : y !== -1 && (y = -1,
                                    clearTimeout(y))
                        }
                    }, {
                        key: "renderRemainTime",
                        value: function(i, t) {
                            var s = "";
                            t > 0 ? i.isZeroSerivce && (s = "此商品仅剩" + i.zeroActiveCount + '件，<span class="price-board-t">' + (0,
                                c.formatRemainTime)(i.zeroActiveTime - f, 2) + "</span>后结束！") : (s = "活动已结束",
                                setTimeout(function() {
                                    window.location.reload()
                                }, 500)),
                                e(".jmod_active_remain_time").html(s)
                        }
                    }, {
                        key: "bindSubmit",
                        value: function(i) {
        ...
        (function(e) {
                ...
                var a = function() {
                    ...
                    return a(i, [{
                        key: "render",
                        value: function(i) {
                            e(".mod-fixed-corp-contact").html((0,
                                n.tmpl)(c, {
                                corpInfo: i
                            }))
                        }
        ...
        (function(e) {
                ...
                var n = function() {
                    ...
                    return n(i, [{
                        ...
                        value: function() {
                            var i = this
                                , t = this.detailModel.getStore()
                                , s = t.skuInfo
                                , a = t.serviceData
                                , n = t.addressIndex
                                , c = t.locationData
                                , d = t.serviceTime
                                , v = t.lastUsedLocation
                                , u = t.nowTime
                                , p = this.detailModel.getDisplayInfo(s, a);
                            a.nowTime = u,
                                this.detailView.renderBreadCrumb(t.cate),
                                this.detailView.renderTips(a),
                                this.detailView.renderActivePrice(a, p),
                                this.changeHongbaoEntry(u),
                                this.detailView.renderSelectCtrl(a, n, c, d),
                                this.detailView.renderCorpInfo(a),
                                this.detailView.renderSKUDetail(a),
                                this.detailView.renderPlatformGarantee(),
                                this.detailView.renderFixedCorpContact(a),
                                this.detailView.bindPeriod(function(e, t) {
                                    i.selectSku(e, t, a, u)
                                }),
                                ...
                                this.detailView.bindSubmit(function(t, s, n) {
                                    var c = i.detailModel.findSkus(t, n)
                                        , r = i.detailModel.getDisplayInfo(c, a);
                                    if (!c || r.idList.length > 1)
                                        return o["default"].showToast("fail", "服务异常，请刷新页面重试。");
                                    var d = r.idList[0];
                                    e('#viewform [name="csId"]').val(a.cs_id),
                                        e('#viewform [name="skuId"]').val(d),
                                        e('#viewform [name="cityId"]').val(t),
                                        e('#viewform [name="provinceId"]').val(s),
                                        a.isZeroSerivce ? e('#viewform [name="activeType"]').val(l.ACTIVITY_TYPE.ZERO) : r.hongbaoInfo ? e('#viewform [name="activeType"]').val(l.ACTIVITY_TYPE.HB) : e('#viewform [name="activeType"]').val("0"),
                                        e(".jmod_buy_btn").addClass("disabled"),
                                        o["default"].toggleLoading(!0),
                                        _["default"].request({
                                            url: "/order/loginuser",
                                            type: "POST",
                                            needRefresh: !0,
                                            ...
                                            complete: function() {
                                                e(".jmod_buy_btn").removeClass("disabled"),
                                                    o["default"].toggleLoading(!1)
                                            }
                                        })
                                });
                            var m = v.lastUsedProvinceId
                                , f = v.lastUsedCityId;
                            f && m ? (e(".jmod_select_province .address-item[_province_id=" + m + "]").trigger("click"),
                                e(".jmod_select_city .address-item[_city_id=" + f + "]").trigger("click")) : "999999" !== m && (+f || this.detailModel.getLastUsedLocationFromServer(function(i, t) {
                                e(".jmod_select_province .address-item[_province_id=" + i + "]").trigger("click"),
                                    e(".jmod_select_city .address-item[_city_id=" + t + "]").trigger("click")
                            })),
                                r["default"].setQQWPA(),
                                r["default"].addQQConsultStat()
                        }
                    }, {
                        key: "selectSku",
                        value: function(e, i, t, s) {
                            var a = this.detailModel.findSkus(e, i)
                                , n = this.detailModel.getDisplayInfo(a, t);
                            this.detailView.renderActivePrice(t, n),
                                this.changeHongbaoEntry(s)
                        }
                    }, {
                        key: "changeHongbaoEntry",
                        value: function(i) {
                            var t = 150264e4
                                , s = 1509465599;
